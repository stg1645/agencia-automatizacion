...
export default function Home() {
  return (
    <main className="min-h-screen bg-zinc-950 text-white font-sans">
      ...
      {/* Services Section */}
      <section className="px-8 pb-20 md:px-24 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 border border-zinc-800 rounded-2xl bg-zinc-900/50 hover:border-blue-500 transition-colors">
          ...
          <p className="text-zinc-400 text-sm">Secure, scalable, and official customer communication channels.</p>
        </div>
        <div className="p-6 border border-zinc-800 rounded-2xl bg-zinc-900/50 hover:border-blue-500 transition-colors">
          <h3 className="text-xl font-bold mb-2">Autonomous AI Agents</h3>
          <p className="text-zinc-400 text-sm">Intelligent bots with memory capabilities to solve complex tasks and streamline support.</p>
        </div>
        <div className="p-6 border border-zinc-800 rounded-2xl bg-zinc-900/50 hover:border-blue-500 transition-colors">
          <h3 className="text-xl font-bold mb-2">n8n Workflows</h3>
          <p className="text-zinc-400 text-sm">Seamless automation connecting your favorite apps without human intervention.</p>
        </div>
      </section>
      ...
      <section className="px-8 py-20 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          ...
          {/* Reemplaza el número con tu WhatsApp de la agencia cuando lo tengas */}
